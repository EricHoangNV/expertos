...
export default function SettingsPage() {
  ...
  // The editor owns the pagehead so the primary Save can live in it (M19.5.5). While loading,
...
function SettingsEditor({ settings, getToken, onSaved }: SettingsEditorProps) {
  ...
  const [temperature, setTemperature] = useState(
    String(settings.llmTemperature),
  );
    ...
    <>
      ...
      <div className="card card-pad col gap2">
        ...
        <Field
          ...
          htmlFor="settings-embedding-provider"
        >
          <Input
