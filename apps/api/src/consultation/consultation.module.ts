 ...
 * missed-event reconcile (Open Decision #10). The {@link TidyCalProvider} comes from an offline-default
...
@Module({
  imports: [AuthModule],
  controllers: [ConsultationRecommendationsController, ConsultationBookingsController],
  providers: [
