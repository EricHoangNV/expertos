...
- Next tasks (priority order):
  1. **M13.7 (admin)** — polish & ds.css conformance audit (`.voice-bar`/`.7.4` gated on M13.5 admin; `.7.1` role-aware sidebar + `.7.5` conformance are actionable now).
  2. **M13.5 (admin)** — Voice profile page: blocked on a schema decision; flag to PM.
