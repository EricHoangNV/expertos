...
- Tests: 1225 pass / 0 fail / 0 skip (shared 179, ui 217, db 9, ai 161, api 661).
...
- Next tasks (priority order):
  1. **M13.2.6–.7** — remaining dashboard cards: Knowledge Pipeline (M13.2.6 — `/knowledge` by status, fully backed), Concierge SLA dark card (M13.2.7 — `/admin/analytics/concierge` SLA, fully backed; also exercises the M13.7.2 `.dark-card`).
