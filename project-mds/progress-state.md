...
- Tests: 1090 pass / 0 fail / 0 skip (shared 179, ui 82, db 9, ai 161, api 659)
...
- Next tasks (priority order):
  1. **M12 (Frontend UI Overhaul)** — M12.1 shell + M12.2 sidebar + M12.3 topbar + M12.4.1 user bubble done. Next: M12.4.2 `.msg-assistant` (expert avatar + name + AI-RENDITION/VERIFIED badges + source label, reuse AnswerView M4.2), M12.4.3–6 (action bar + recommendation/insufficient/high-stakes cards), M12.5 sources rail, M12.6 input bar, M12.7 Tweaks panel. Read `requirements/ui-reference-spec.md` first. Avatar helpers (`avatarInitials`/`avatarTone` + `.avatar.tone-*`) are reusable for M12.4.2.
