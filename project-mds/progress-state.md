...
- Next tasks (priority order):
  1. **M13.4** — Plans & Entitlements matrix (`.matrix-table` editable grid; wire to `/admin/entitlements`).
  2. **M13.5–M13.7** — voice profile page, concierge review queue, shared patterns (`.voice-bar`/`.verdict-card`/`.matrix-table` still to come).
