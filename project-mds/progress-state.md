...
- Next tasks (priority order):
  1. **M13.2.5–.7** — remaining dashboard cards: Low-Confidence Queries (M13.2.5 — `/admin/failed-queries`, fully backed), Knowledge Pipeline (M13.2.6 — `/knowledge` by status, fully backed), Concierge SLA dark card (M13.2.7 — `/admin/analytics/concierge` SLA, fully backed; also exercises the M13.7.2 `.dark-card`).
