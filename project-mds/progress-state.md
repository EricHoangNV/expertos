...
## Next tasks — all FAIL/Medium in-sandbox code work cleared; remaining is re-review + non-code + blocked
...
2. **Host-validate M15.3.3/.4/.5** — host runs dev stack + allowlist `host.docker.internal:3000-3002,9099`.
